...
public:
    ...
    UpdateCustomQueryDTO(const UpdateCustomQueryDTO &other)
    ...
    UpdateCustomQueryDTO &operator=(const UpdateCustomQueryDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateCustomQueryDTO &mergeWith(const UpdateCustomQueryDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateCustomQueryDTO &lhs, const UpdateCustomQueryDTO &rhs);

    friend uint qHash(const UpdateCustomQueryDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateCustomQueryDTO &lhs, const UpdateCustomQueryDTO &rhs)
{
...
inline uint qHash(const UpdateCustomQueryDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CustomQuery::UpdateCustomQueryDTO)
