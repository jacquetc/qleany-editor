...
class QLEANY_EDITOR_CONTRACTS_EXPORT InterfaceContractsComponentRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<QleanyEditor::Entities::ContractsComponent>,
      public Qleany::Contracts::Repository::InterfaceRepository
{
public:
    virtual ~InterfaceContractsComponentRepository()
    {
    }
