...
public:
    ...
    GlobalComponentDTO(const GlobalComponentDTO &other)
    ...
    GlobalComponentDTO &operator=(const GlobalComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    GlobalComponentDTO &mergeWith(const GlobalComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const GlobalComponentDTO &lhs, const GlobalComponentDTO &rhs);

    friend uint qHash(const GlobalComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const GlobalComponentDTO &lhs, const GlobalComponentDTO &rhs)
{
...
inline uint qHash(const GlobalComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::GlobalComponent::GlobalComponentDTO)