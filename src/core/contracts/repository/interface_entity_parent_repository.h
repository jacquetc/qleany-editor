...
class QLEANY_EDITOR_CONTRACTS_EXPORT InterfaceEntityParentRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<QleanyEditor::Entities::EntityParent>,
      public Qleany::Contracts::Repository::InterfaceRepository
{
public:
    virtual ~InterfaceEntityParentRepository()
    {
    }
