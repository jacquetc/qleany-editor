...
{
class QLEANY_EDITOR_APPLICATION_APPLICATION_COMPONENT_EXPORT GetApplicationComponentQueryHandler : public QObject
{
    Q_OBJECT
public:
    GetApplicationComponentQueryHandler(InterfaceApplicationComponentRepository *repository);
    Result<ApplicationComponentDTO> handle(QPromise<Result<void>> &progressPromise, const GetApplicationComponentQuery &query);

private:
    InterfaceApplicationComponentRepository *m_repository;
    Result<ApplicationComponentDTO> handleImpl(QPromise<Result<void>> &progressPromise, const GetApplicationComponentQuery &query);
