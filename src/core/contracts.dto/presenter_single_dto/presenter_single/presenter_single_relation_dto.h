...
class PresenterSingleRelationDTO
{
    Q_GADGET
...
public:
    ...
    enum RelationField { Undefined, Entity };
    Q_ENUM(RelationField);

    PresenterSingleRelationDTO()
        : m_id(0)
    ...
    PresenterSingleRelationDTO(int id, const RelationField &relationField, const QList<int> &relatedIds, int position)
        : m_id(id)
    ...
    PresenterSingleRelationDTO(const PresenterSingleRelationDTO &other)
    ...
    PresenterSingleRelationDTO &operator=(const PresenterSingleRelationDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    PresenterSingleRelationDTO &mergeWith(const PresenterSingleRelationDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const PresenterSingleRelationDTO &lhs, const PresenterSingleRelationDTO &rhs);

    friend uint qHash(const PresenterSingleRelationDTO &dto, uint seed) noexcept;
...
inline bool operator==(const PresenterSingleRelationDTO &lhs, const PresenterSingleRelationDTO &rhs)
{
...
inline uint qHash(const PresenterSingleRelationDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::PresenterSingle::PresenterSingleRelationDTO)