...
{
class RemovePresenterComponentCommandValidator
{
public:
    RemovePresenterComponentCommandValidator(InterfacePresenterComponentRepository *presenterComponentRepository)
    ...
    {
        Result<bool> existsResult = m_presenterComponentRepository->exists(id);
