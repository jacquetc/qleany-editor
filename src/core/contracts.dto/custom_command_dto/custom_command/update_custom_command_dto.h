...
public:
    ...
    UpdateCustomCommandDTO(const UpdateCustomCommandDTO &other)
    ...
    UpdateCustomCommandDTO &operator=(const UpdateCustomCommandDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateCustomCommandDTO &mergeWith(const UpdateCustomCommandDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateCustomCommandDTO &lhs, const UpdateCustomCommandDTO &rhs);

    friend uint qHash(const UpdateCustomCommandDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateCustomCommandDTO &lhs, const UpdateCustomCommandDTO &rhs)
{
...
inline uint qHash(const UpdateCustomCommandDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CustomCommand::UpdateCustomCommandDTO)
