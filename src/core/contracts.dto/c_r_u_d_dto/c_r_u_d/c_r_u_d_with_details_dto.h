...
public:
    ...
    CRUDWithDetailsDTO(const CRUDWithDetailsDTO &other)
    ...
    CRUDWithDetailsDTO &operator=(const CRUDWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    CRUDWithDetailsDTO &mergeWith(const CRUDWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const CRUDWithDetailsDTO &lhs, const CRUDWithDetailsDTO &rhs);

    friend uint qHash(const CRUDWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const CRUDWithDetailsDTO &lhs, const CRUDWithDetailsDTO &rhs)
{
...
inline uint qHash(const CRUDWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CRUD::CRUDWithDetailsDTO)