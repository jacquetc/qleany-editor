...
public:
    ...
    UpdateDTOComponentDTO(int id, const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate, const QString &commonCMakeFolderPath)
        : m_id(id)
        , m_uuid(uuid)
    ...
    UpdateDTOComponentDTO(const UpdateDTOComponentDTO &other)
    ...
    UpdateDTOComponentDTO &operator=(const UpdateDTOComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateDTOComponentDTO &mergeWith(const UpdateDTOComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateDTOComponentDTO &lhs, const UpdateDTOComponentDTO &rhs);

    friend uint qHash(const UpdateDTOComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateDTOComponentDTO &lhs, const UpdateDTOComponentDTO &rhs)
{
...
inline uint qHash(const UpdateDTOComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::DTOComponent::UpdateDTOComponentDTO)