...
class QLEANY_EDITOR_PERSISTENCE_EXPORT FrontEndComponentRepository final
    : public Qleany::Repository::GenericRepository<QleanyEditor::Entities::FrontEndComponent>,
      public QleanyEditor::Contracts::Repository::InterfaceFrontEndComponentRepository
{
public:
    explicit FrontEndComponentRepository(InterfaceDatabaseTableGroup<QleanyEditor::Entities::FrontEndComponent> *frontEndComponentDatabase);
