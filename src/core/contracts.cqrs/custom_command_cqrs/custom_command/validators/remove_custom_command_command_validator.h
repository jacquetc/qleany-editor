...
{
class RemoveCustomCommandCommandValidator
{
public:
    RemoveCustomCommandCommandValidator(InterfaceCustomCommandRepository *customCommandRepository)
    ...
    {
        Result<bool> existsResult = m_customCommandRepository->exists(id);
