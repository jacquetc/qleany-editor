...
class UpdateApplicationComponentDTO
{
    Q_GADGET
...
public:
    ...
    UpdateApplicationComponentDTO(int id,
                                  const QUuid &uuid,
    ...
    UpdateApplicationComponentDTO(const UpdateApplicationComponentDTO &other)
    ...
    UpdateApplicationComponentDTO &operator=(const UpdateApplicationComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateApplicationComponentDTO &mergeWith(const UpdateApplicationComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateApplicationComponentDTO &lhs, const UpdateApplicationComponentDTO &rhs);

    friend uint qHash(const UpdateApplicationComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateApplicationComponentDTO &lhs, const UpdateApplicationComponentDTO &rhs)
{
...
inline uint qHash(const UpdateApplicationComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::ApplicationComponent::UpdateApplicationComponentDTO)