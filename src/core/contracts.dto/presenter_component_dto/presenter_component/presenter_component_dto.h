...
public:
    ...
    PresenterComponentDTO(const PresenterComponentDTO &other)
    ...
    PresenterComponentDTO &operator=(const PresenterComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    PresenterComponentDTO &mergeWith(const PresenterComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const PresenterComponentDTO &lhs, const PresenterComponentDTO &rhs);

    friend uint qHash(const PresenterComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const PresenterComponentDTO &lhs, const PresenterComponentDTO &rhs)
{
    return lhs.m_id == rhs.m_id && lhs.m_uuid == rhs.m_uuid && lhs.m_creationDate == rhs.m_creationDate && lhs.m_updateDate == rhs.m_updateDate
        && lhs.m_folderPath == rhs.m_folderPath && lhs.m_createUndoAndRedoSingles == rhs.m_createUndoAndRedoSingles;
}

inline uint qHash(const PresenterComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::PresenterComponent::PresenterComponentDTO)