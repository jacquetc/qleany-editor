...
public:
    ...
    UpdateCustomDTODTO(const UpdateCustomDTODTO &other)
    ...
    UpdateCustomDTODTO &operator=(const UpdateCustomDTODTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateCustomDTODTO &mergeWith(const UpdateCustomDTODTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateCustomDTODTO &lhs, const UpdateCustomDTODTO &rhs);

    friend uint qHash(const UpdateCustomDTODTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateCustomDTODTO &lhs, const UpdateCustomDTODTO &rhs)
{
...
inline uint qHash(const UpdateCustomDTODTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CustomDTO::UpdateCustomDTODTO)
