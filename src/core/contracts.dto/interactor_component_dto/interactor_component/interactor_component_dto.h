...
public:
    ...
    InteractorComponentDTO(const InteractorComponentDTO &other)
    ...
    InteractorComponentDTO &operator=(const InteractorComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    InteractorComponentDTO &mergeWith(const InteractorComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const InteractorComponentDTO &lhs, const InteractorComponentDTO &rhs);

    friend uint qHash(const InteractorComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const InteractorComponentDTO &lhs, const InteractorComponentDTO &rhs)
{
...
inline uint qHash(const InteractorComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::InteractorComponent::InteractorComponentDTO)