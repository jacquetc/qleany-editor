...
class QLEANY_EDITOR_CONTRACTS_EXPORT InterfaceRecentProjectRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<QleanyEditor::Entities::RecentProject>,
      public Qleany::Contracts::Repository::InterfaceRepository
{
public:
    virtual ~InterfaceRecentProjectRepository()
    {
    }
