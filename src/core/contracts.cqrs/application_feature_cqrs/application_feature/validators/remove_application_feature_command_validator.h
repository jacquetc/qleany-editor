...
{
class RemoveApplicationFeatureCommandValidator
{
public:
    RemoveApplicationFeatureCommandValidator(InterfaceApplicationFeatureRepository *applicationFeatureRepository)
    ...
    {
        Result<bool> existsResult = m_applicationFeatureRepository->exists(id);
