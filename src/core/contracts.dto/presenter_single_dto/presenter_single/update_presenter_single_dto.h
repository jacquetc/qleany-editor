...
class UpdatePresenterSingleDTO
{
    Q_GADGET
...
public:
    ...
    UpdatePresenterSingleDTO(int id,
                             const QUuid &uuid,
    ...
    UpdatePresenterSingleDTO(const UpdatePresenterSingleDTO &other)
    ...
    UpdatePresenterSingleDTO &operator=(const UpdatePresenterSingleDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdatePresenterSingleDTO &mergeWith(const UpdatePresenterSingleDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdatePresenterSingleDTO &lhs, const UpdatePresenterSingleDTO &rhs);

    friend uint qHash(const UpdatePresenterSingleDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdatePresenterSingleDTO &lhs, const UpdatePresenterSingleDTO &rhs)
{
...
inline uint qHash(const UpdatePresenterSingleDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::PresenterSingle::UpdatePresenterSingleDTO)