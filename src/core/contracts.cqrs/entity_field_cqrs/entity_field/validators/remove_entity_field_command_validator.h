...
{
class RemoveEntityFieldCommandValidator
{
public:
    RemoveEntityFieldCommandValidator(InterfaceEntityFieldRepository *entityFieldRepository)
    ...
    {
        Result<bool> existsResult = m_entityFieldRepository->exists(id);
