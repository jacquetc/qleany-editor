...
class UpdateFrontEndComponentDTO
{
    Q_GADGET
...
public:
    ...
    UpdateFrontEndComponentDTO(int id,
                               const QUuid &uuid,
    ...
    UpdateFrontEndComponentDTO(const UpdateFrontEndComponentDTO &other)
    ...
    UpdateFrontEndComponentDTO &operator=(const UpdateFrontEndComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateFrontEndComponentDTO &mergeWith(const UpdateFrontEndComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateFrontEndComponentDTO &lhs, const UpdateFrontEndComponentDTO &rhs);

    friend uint qHash(const UpdateFrontEndComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateFrontEndComponentDTO &lhs, const UpdateFrontEndComponentDTO &rhs)
{
...
inline uint qHash(const UpdateFrontEndComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::FrontEndComponent::UpdateFrontEndComponentDTO)