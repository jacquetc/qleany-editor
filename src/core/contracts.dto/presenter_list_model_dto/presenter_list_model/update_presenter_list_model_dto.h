...
class UpdatePresenterListModelDTO
{
    Q_GADGET
...
public:
    ...
    UpdatePresenterListModelDTO(int id,
                                const QUuid &uuid,
    ...
    UpdatePresenterListModelDTO(const UpdatePresenterListModelDTO &other)
    ...
    UpdatePresenterListModelDTO &operator=(const UpdatePresenterListModelDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdatePresenterListModelDTO &mergeWith(const UpdatePresenterListModelDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdatePresenterListModelDTO &lhs, const UpdatePresenterListModelDTO &rhs);

    friend uint qHash(const UpdatePresenterListModelDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdatePresenterListModelDTO &lhs, const UpdatePresenterListModelDTO &rhs)
{
...
inline uint qHash(const UpdatePresenterListModelDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::PresenterListModel::UpdatePresenterListModelDTO)