...
{
class RemoveApplicationComponentCommandValidator
{
public:
    RemoveApplicationComponentCommandValidator(InterfaceApplicationComponentRepository *applicationComponentRepository)
    ...
    {
        Result<bool> existsResult = m_applicationComponentRepository->exists(id);
