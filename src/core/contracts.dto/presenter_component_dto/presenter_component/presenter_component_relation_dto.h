...
class PresenterComponentRelationDTO
{
    Q_GADGET
...
public:
    ...
    enum RelationField { Undefined, Singles, ListModels };
    Q_ENUM(RelationField);

    PresenterComponentRelationDTO()
        : m_id(0)
    ...
    PresenterComponentRelationDTO(int id, const RelationField &relationField, const QList<int> &relatedIds, int position)
        : m_id(id)
    ...
    PresenterComponentRelationDTO(const PresenterComponentRelationDTO &other)
    ...
    PresenterComponentRelationDTO &operator=(const PresenterComponentRelationDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    PresenterComponentRelationDTO &mergeWith(const PresenterComponentRelationDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const PresenterComponentRelationDTO &lhs, const PresenterComponentRelationDTO &rhs);

    friend uint qHash(const PresenterComponentRelationDTO &dto, uint seed) noexcept;
...
inline bool operator==(const PresenterComponentRelationDTO &lhs, const PresenterComponentRelationDTO &rhs)
{
...
inline uint qHash(const PresenterComponentRelationDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::PresenterComponent::PresenterComponentRelationDTO)