...
class RepositoryComponentRelationDTO
{
    Q_GADGET
...
public:
    ...
    enum RelationField { Undefined, Repositories };
    Q_ENUM(RelationField);

    RepositoryComponentRelationDTO()
        : m_id(0)
    ...
    RepositoryComponentRelationDTO(int id, const RelationField &relationField, const QList<int> &relatedIds, int position)
        : m_id(id)
    ...
    RepositoryComponentRelationDTO(const RepositoryComponentRelationDTO &other)
    ...
    RepositoryComponentRelationDTO &operator=(const RepositoryComponentRelationDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    RepositoryComponentRelationDTO &mergeWith(const RepositoryComponentRelationDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const RepositoryComponentRelationDTO &lhs, const RepositoryComponentRelationDTO &rhs);

    friend uint qHash(const RepositoryComponentRelationDTO &dto, uint seed) noexcept;
...
inline bool operator==(const RepositoryComponentRelationDTO &lhs, const RepositoryComponentRelationDTO &rhs)
{
...
inline uint qHash(const RepositoryComponentRelationDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::RepositoryComponent::RepositoryComponentRelationDTO)