...
class QLEANY_EDITOR_PERSISTENCE_EXPORT CQRSComponentRepository final : public Qleany::Repository::GenericRepository<QleanyEditor::Entities::CQRSComponent>,
                                                                       public QleanyEditor::Contracts::Repository::InterfaceCQRSComponentRepository
{
public:
    explicit CQRSComponentRepository(InterfaceDatabaseTableGroup<QleanyEditor::Entities::CQRSComponent> *cQRSComponentDatabase);
