...
public:
    ...
    EntityWithDetailsDTO(const EntityWithDetailsDTO &other)
    ...
    EntityWithDetailsDTO &operator=(const EntityWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    EntityWithDetailsDTO &mergeWith(const EntityWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const EntityWithDetailsDTO &lhs, const EntityWithDetailsDTO &rhs);

    friend uint qHash(const EntityWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const EntityWithDetailsDTO &lhs, const EntityWithDetailsDTO &rhs)
{
...
inline uint qHash(const EntityWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::Entity::EntityWithDetailsDTO)