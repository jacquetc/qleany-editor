...
class UpdatePresenterComponentDTO
{
    Q_GADGET
...
public:
    ...
    UpdatePresenterComponentDTO(int id,
                                const QUuid &uuid,
    ...
    UpdatePresenterComponentDTO(const UpdatePresenterComponentDTO &other)
    ...
    UpdatePresenterComponentDTO &operator=(const UpdatePresenterComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdatePresenterComponentDTO &mergeWith(const UpdatePresenterComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdatePresenterComponentDTO &lhs, const UpdatePresenterComponentDTO &rhs);

    friend uint qHash(const UpdatePresenterComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdatePresenterComponentDTO &lhs, const UpdatePresenterComponentDTO &rhs)
{
...
inline uint qHash(const UpdatePresenterComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::PresenterComponent::UpdatePresenterComponentDTO)