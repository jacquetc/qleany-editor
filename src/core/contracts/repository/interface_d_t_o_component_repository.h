...
class QLEANY_EDITOR_CONTRACTS_EXPORT InterfaceDTOComponentRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<QleanyEditor::Entities::DTOComponent>,
      public Qleany::Contracts::Repository::InterfaceRepository
{
public:
    virtual ~InterfaceDTOComponentRepository()
    {
    }
