...
public:
    ...
    ContractsComponentDTO(const ContractsComponentDTO &other)
    ...
    ContractsComponentDTO &operator=(const ContractsComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    ContractsComponentDTO &mergeWith(const ContractsComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const ContractsComponentDTO &lhs, const ContractsComponentDTO &rhs);

    friend uint qHash(const ContractsComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const ContractsComponentDTO &lhs, const ContractsComponentDTO &rhs)
{
...
inline uint qHash(const ContractsComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::ContractsComponent::ContractsComponentDTO)