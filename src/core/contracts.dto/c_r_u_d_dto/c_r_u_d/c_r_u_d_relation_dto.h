...
public:
    ...
    enum RelationField { Undefined, EntityMappableWith };
    ...
    CRUDRelationDTO(int id, const RelationField &relationField, const QList<int> &relatedIds, int position)
        : m_id(id)
    ...
    CRUDRelationDTO(const CRUDRelationDTO &other)
    ...
    CRUDRelationDTO &operator=(const CRUDRelationDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    CRUDRelationDTO &mergeWith(const CRUDRelationDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const CRUDRelationDTO &lhs, const CRUDRelationDTO &rhs);

    friend uint qHash(const CRUDRelationDTO &dto, uint seed) noexcept;
...
inline bool operator==(const CRUDRelationDTO &lhs, const CRUDRelationDTO &rhs)
{
...
inline uint qHash(const CRUDRelationDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CRUD::CRUDRelationDTO)