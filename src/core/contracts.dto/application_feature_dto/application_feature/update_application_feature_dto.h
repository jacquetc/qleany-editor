...
class UpdateApplicationFeatureDTO
{
    Q_GADGET
...
public:
    ...
    UpdateApplicationFeatureDTO(int id,
                                const QUuid &uuid,
    ...
    UpdateApplicationFeatureDTO(const UpdateApplicationFeatureDTO &other)
    ...
    UpdateApplicationFeatureDTO &operator=(const UpdateApplicationFeatureDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateApplicationFeatureDTO &mergeWith(const UpdateApplicationFeatureDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateApplicationFeatureDTO &lhs, const UpdateApplicationFeatureDTO &rhs);

    friend uint qHash(const UpdateApplicationFeatureDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateApplicationFeatureDTO &lhs, const UpdateApplicationFeatureDTO &rhs)
{
...
inline uint qHash(const UpdateApplicationFeatureDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::ApplicationFeature::UpdateApplicationFeatureDTO)