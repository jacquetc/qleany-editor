...
class PresenterSingleWithDetailsDTO
{
    Q_GADGET
...
public:
    ...
    PresenterSingleWithDetailsDTO(int id,
                                  const QUuid &uuid,
    ...
    PresenterSingleWithDetailsDTO(const PresenterSingleWithDetailsDTO &other)
    ...
    PresenterSingleWithDetailsDTO &operator=(const PresenterSingleWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    PresenterSingleWithDetailsDTO &mergeWith(const PresenterSingleWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const PresenterSingleWithDetailsDTO &lhs, const PresenterSingleWithDetailsDTO &rhs);

    friend uint qHash(const PresenterSingleWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const PresenterSingleWithDetailsDTO &lhs, const PresenterSingleWithDetailsDTO &rhs)
{
...
inline uint qHash(const PresenterSingleWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::PresenterSingle::PresenterSingleWithDetailsDTO)