...
class CustomQuery : public CommonParent
{
    Q_GADGET
...
public:
    struct MetaData {
        MetaData(CustomQuery *entity)
            : m_entity(entity)
        {
        }
        MetaData(CustomQuery *entity, const MetaData &other)
            : m_entity(entity)
        {
    ...
    CustomQuery(const CustomQuery &other)
        : CommonParent(other)
    ...
    {
        return QleanyEditor::Entities::Entities::EntityEnum::CustomQuery;
    }

    CustomQuery &operator=(const CustomQuery &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const CustomQuery &lhs, const CustomQuery &rhs);

    friend uint qHash(const CustomQuery &entity, uint seed) noexcept;
...
inline bool operator==(const CustomQuery &lhs, const CustomQuery &rhs)
{
...
inline uint qHash(const CustomQuery &entity, uint seed = 0) noexcept
...
/// Schema for CustomQuery entity
inline Qleany::Entities::EntitySchema CustomQuery::schema = {QleanyEditor::Entities::Entities::EntityEnum::CustomQuery,
                                                             "CustomQuery"_L1,
...
Q_DECLARE_METATYPE(QleanyEditor::Entities::CustomQuery)