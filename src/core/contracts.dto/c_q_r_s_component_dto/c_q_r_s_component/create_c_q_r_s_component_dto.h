...
namespace QleanyEditor::Contracts::DTO::CQRSComponent
{
using namespace Qt::Literals::StringLiterals;

class CreateCQRSComponentDTO
{
    Q_GADGET
...
public:
    ...
    CreateCQRSComponentDTO(const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate, const QString &commonCMakeFolderPath, int projectId)
        : m_uuid(uuid)
    ...
    CreateCQRSComponentDTO(const CreateCQRSComponentDTO &other)
    ...
    CreateCQRSComponentDTO &operator=(const CreateCQRSComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_uuid = other.m_uuid;
    ...
    CreateCQRSComponentDTO &mergeWith(const CreateCQRSComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const CreateCQRSComponentDTO &lhs, const CreateCQRSComponentDTO &rhs);

    friend uint qHash(const CreateCQRSComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const CreateCQRSComponentDTO &lhs, const CreateCQRSComponentDTO &rhs)
{
...
inline uint qHash(const CreateCQRSComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CQRSComponent::CreateCQRSComponentDTO)