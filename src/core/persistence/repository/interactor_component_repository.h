...
class QLEANY_EDITOR_PERSISTENCE_EXPORT InteractorComponentRepository final
    : public Qleany::Repository::GenericRepository<QleanyEditor::Entities::InteractorComponent>,
      public QleanyEditor::Contracts::Repository::InterfaceInteractorComponentRepository
{
public:
    explicit InteractorComponentRepository(InterfaceDatabaseTableGroup<QleanyEditor::Entities::InteractorComponent> *interactorComponentDatabase);
