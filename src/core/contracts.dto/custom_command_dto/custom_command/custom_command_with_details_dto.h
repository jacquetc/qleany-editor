...
class CustomCommandWithDetailsDTO
{
    Q_GADGET
...
public:
    ...
    CustomCommandWithDetailsDTO(int id,
                                const QUuid &uuid,
    ...
    CustomCommandWithDetailsDTO(const CustomCommandWithDetailsDTO &other)
    ...
    CustomCommandWithDetailsDTO &operator=(const CustomCommandWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    CustomCommandWithDetailsDTO &mergeWith(const CustomCommandWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const CustomCommandWithDetailsDTO &lhs, const CustomCommandWithDetailsDTO &rhs);

    friend uint qHash(const CustomCommandWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const CustomCommandWithDetailsDTO &lhs, const CustomCommandWithDetailsDTO &rhs)
{
...
inline uint qHash(const CustomCommandWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CustomCommand::CustomCommandWithDetailsDTO)
