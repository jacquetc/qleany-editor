...
public:
    ...
    CreateCustomQueryDTO(const QUuid &uuid,
    ...
    CreateCustomQueryDTO(const CreateCustomQueryDTO &other)
    ...
    CreateCustomQueryDTO &operator=(const CreateCustomQueryDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_uuid = other.m_uuid;
    ...
    CreateCustomQueryDTO &mergeWith(const CreateCustomQueryDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const CreateCustomQueryDTO &lhs, const CreateCustomQueryDTO &rhs);

    friend uint qHash(const CreateCustomQueryDTO &dto, uint seed) noexcept;
...
inline bool operator==(const CreateCustomQueryDTO &lhs, const CreateCustomQueryDTO &rhs)
{
...
inline uint qHash(const CreateCustomQueryDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CustomQuery::CreateCustomQueryDTO)
