...
class RepositoryComponentWithDetailsDTO
{
    Q_GADGET
...
public:
    ...
    RepositoryComponentWithDetailsDTO()
        : m_id(0)
        , m_uuid(QUuid())
    ...
    RepositoryComponentWithDetailsDTO(int id,
                                      const QUuid &uuid,
    ...
    RepositoryComponentWithDetailsDTO(const RepositoryComponentWithDetailsDTO &other)
    ...
    RepositoryComponentWithDetailsDTO &operator=(const RepositoryComponentWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    RepositoryComponentWithDetailsDTO &mergeWith(const RepositoryComponentWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const RepositoryComponentWithDetailsDTO &lhs, const RepositoryComponentWithDetailsDTO &rhs);

    friend uint qHash(const RepositoryComponentWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const RepositoryComponentWithDetailsDTO &lhs, const RepositoryComponentWithDetailsDTO &rhs)
{
...
inline uint qHash(const RepositoryComponentWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::RepositoryComponent::RepositoryComponentWithDetailsDTO)