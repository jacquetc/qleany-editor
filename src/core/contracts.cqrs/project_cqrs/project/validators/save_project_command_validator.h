...
{
class SaveProjectCommandValidator
{
public:
    SaveProjectCommandValidator(InterfaceProjectRepository *projectRepository, InterfaceGlobalComponentRepository *globalComponentRepository)
        : m_projectRepository(projectRepository)
        , m_globalComponentRepository(globalComponentRepository)
    {
    }

    Result<void> validate(const SaveProjectDTO &dto) const
