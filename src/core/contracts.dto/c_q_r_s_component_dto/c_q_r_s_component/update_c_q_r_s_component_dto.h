...
public:
    ...
    UpdateCQRSComponentDTO(int id, const QUuid &uuid, const QDateTime &creationDate, const QDateTime &updateDate, const QString &commonCMakeFolderPath)
        : m_id(id)
        , m_uuid(uuid)
    ...
    UpdateCQRSComponentDTO(const UpdateCQRSComponentDTO &other)
    ...
    UpdateCQRSComponentDTO &operator=(const UpdateCQRSComponentDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateCQRSComponentDTO &mergeWith(const UpdateCQRSComponentDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateCQRSComponentDTO &lhs, const UpdateCQRSComponentDTO &rhs);

    friend uint qHash(const UpdateCQRSComponentDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateCQRSComponentDTO &lhs, const UpdateCQRSComponentDTO &rhs)
{
...
inline uint qHash(const UpdateCQRSComponentDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CQRSComponent::UpdateCQRSComponentDTO)