...
{
class RemoveInteractorComponentCommandValidator
{
public:
    RemoveInteractorComponentCommandValidator(InterfaceInteractorComponentRepository *interactorComponentRepository)
    ...
    {
        Result<bool> existsResult = m_interactorComponentRepository->exists(id);
