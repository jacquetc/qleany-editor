...
class ApplicationComponentWithDetailsDTO
{
    Q_GADGET
...
public:
    ...
    ApplicationComponentWithDetailsDTO()
        : m_id(0)
        , m_uuid(QUuid())
    ...
    ApplicationComponentWithDetailsDTO(int id,
                                       const QUuid &uuid,
    ...
    ApplicationComponentWithDetailsDTO(const ApplicationComponentWithDetailsDTO &other)
    ...
    ApplicationComponentWithDetailsDTO &operator=(const ApplicationComponentWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    ApplicationComponentWithDetailsDTO &mergeWith(const ApplicationComponentWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const ApplicationComponentWithDetailsDTO &lhs, const ApplicationComponentWithDetailsDTO &rhs);

    friend uint qHash(const ApplicationComponentWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const ApplicationComponentWithDetailsDTO &lhs, const ApplicationComponentWithDetailsDTO &rhs)
{
...
inline uint qHash(const ApplicationComponentWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::ApplicationComponent::ApplicationComponentWithDetailsDTO)