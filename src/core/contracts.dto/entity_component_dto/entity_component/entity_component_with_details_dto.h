...
public:
    ...
    EntityComponentWithDetailsDTO(int id,
                                  const QUuid &uuid,
    ...
    EntityComponentWithDetailsDTO(const EntityComponentWithDetailsDTO &other)
    ...
    EntityComponentWithDetailsDTO &operator=(const EntityComponentWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    EntityComponentWithDetailsDTO &mergeWith(const EntityComponentWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const EntityComponentWithDetailsDTO &lhs, const EntityComponentWithDetailsDTO &rhs);

    friend uint qHash(const EntityComponentWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const EntityComponentWithDetailsDTO &lhs, const EntityComponentWithDetailsDTO &rhs)
{
...
inline uint qHash(const EntityComponentWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::EntityComponent::EntityComponentWithDetailsDTO)