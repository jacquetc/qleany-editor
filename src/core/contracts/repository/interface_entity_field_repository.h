...
class QLEANY_EDITOR_CONTRACTS_EXPORT InterfaceEntityFieldRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<QleanyEditor::Entities::EntityField>,
      public Qleany::Contracts::Repository::InterfaceRepository
{
public:
    virtual ~InterfaceEntityFieldRepository()
    {
    }
