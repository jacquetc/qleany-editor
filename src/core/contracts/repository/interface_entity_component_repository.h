...
class QLEANY_EDITOR_CONTRACTS_EXPORT InterfaceEntityComponentRepository
    : public virtual Qleany::Contracts::Repository::InterfaceGenericRepository<QleanyEditor::Entities::EntityComponent>,
      public Qleany::Contracts::Repository::InterfaceRepository
{
public:
    virtual ~InterfaceEntityComponentRepository()
    {
    }
