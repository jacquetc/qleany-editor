...
{
class QLEANY_EDITOR_APPLICATION_PRESENTER_COMPONENT_EXPORT GetPresenterComponentWithDetailsQueryHandler : public QObject
{
    Q_OBJECT
public:
    GetPresenterComponentWithDetailsQueryHandler(InterfacePresenterComponentRepository *repository);
    Result<PresenterComponentWithDetailsDTO> handle(QPromise<Result<void>> &progressPromise, const GetPresenterComponentQuery &query);

private:
    InterfacePresenterComponentRepository *m_repository;
    Result<PresenterComponentWithDetailsDTO> handleImpl(QPromise<Result<void>> &progressPromise, const GetPresenterComponentQuery &query);
