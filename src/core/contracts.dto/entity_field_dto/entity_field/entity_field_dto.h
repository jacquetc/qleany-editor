...
public:
    ...
    EntityFieldDTO(const EntityFieldDTO &other)
    ...
    EntityFieldDTO &operator=(const EntityFieldDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    EntityFieldDTO &mergeWith(const EntityFieldDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const EntityFieldDTO &lhs, const EntityFieldDTO &rhs);

    friend uint qHash(const EntityFieldDTO &dto, uint seed) noexcept;
...
inline bool operator==(const EntityFieldDTO &lhs, const EntityFieldDTO &rhs)
{
...
inline uint qHash(const EntityFieldDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::EntityField::EntityFieldDTO)