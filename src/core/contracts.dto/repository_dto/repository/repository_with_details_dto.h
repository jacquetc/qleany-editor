...
class RepositoryWithDetailsDTO
{
    Q_GADGET
...
public:
    ...
    RepositoryWithDetailsDTO(int id,
                             const QUuid &uuid,
    ...
    RepositoryWithDetailsDTO(const RepositoryWithDetailsDTO &other)
    ...
    RepositoryWithDetailsDTO &operator=(const RepositoryWithDetailsDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    RepositoryWithDetailsDTO &mergeWith(const RepositoryWithDetailsDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const RepositoryWithDetailsDTO &lhs, const RepositoryWithDetailsDTO &rhs);

    friend uint qHash(const RepositoryWithDetailsDTO &dto, uint seed) noexcept;
...
inline bool operator==(const RepositoryWithDetailsDTO &lhs, const RepositoryWithDetailsDTO &rhs)
{
...
inline uint qHash(const RepositoryWithDetailsDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::Repository::RepositoryWithDetailsDTO)