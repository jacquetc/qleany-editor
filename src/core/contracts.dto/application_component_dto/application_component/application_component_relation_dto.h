...
class ApplicationComponentRelationDTO
{
    Q_GADGET
...
public:
    ...
    enum RelationField { Undefined, Features };
    Q_ENUM(RelationField);

    ApplicationComponentRelationDTO()
        : m_id(0)
    ...
    ApplicationComponentRelationDTO(int id, const RelationField &relationField, const QList<int> &relatedIds, int position)
        : m_id(id)
    ...
    ApplicationComponentRelationDTO(const ApplicationComponentRelationDTO &other)
    ...
    ApplicationComponentRelationDTO &operator=(const ApplicationComponentRelationDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    ApplicationComponentRelationDTO &mergeWith(const ApplicationComponentRelationDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const ApplicationComponentRelationDTO &lhs, const ApplicationComponentRelationDTO &rhs);

    friend uint qHash(const ApplicationComponentRelationDTO &dto, uint seed) noexcept;
...
inline bool operator==(const ApplicationComponentRelationDTO &lhs, const ApplicationComponentRelationDTO &rhs)
{
...
inline uint qHash(const ApplicationComponentRelationDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::ApplicationComponent::ApplicationComponentRelationDTO)