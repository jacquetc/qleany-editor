...
public:
    ...
    UpdateCRUDDTO(const UpdateCRUDDTO &other)
    ...
    UpdateCRUDDTO &operator=(const UpdateCRUDDTO &other)
    {
        if (this != &other) {
            m_metaData = other.m_metaData;
            m_id = other.m_id;
    ...
    UpdateCRUDDTO &mergeWith(const UpdateCRUDDTO &other)
    {
        if (this != &other) {
    ...
    friend bool operator==(const UpdateCRUDDTO &lhs, const UpdateCRUDDTO &rhs);

    friend uint qHash(const UpdateCRUDDTO &dto, uint seed) noexcept;
...
inline bool operator==(const UpdateCRUDDTO &lhs, const UpdateCRUDDTO &rhs)
{
...
inline uint qHash(const UpdateCRUDDTO &dto, uint seed = 0) noexcept
...
Q_DECLARE_METATYPE(QleanyEditor::Contracts::DTO::CRUD::UpdateCRUDDTO)